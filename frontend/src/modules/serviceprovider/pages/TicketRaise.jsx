        ...
        <div className="flex flex-col h-screen bg-slate-50">
            ...
            <div className="bg-white px-4 py-3 border-b border-slate-100 sticky top-0 z-30 transition-all">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-lg font-black text-slate-900 tracking-tight flex items-center gap-2 leading-none">
                        <Ticket className="h-4 w-4 text-purple-600" /> Raise a Ticket
                    </h1>
                </div>
            </div>
