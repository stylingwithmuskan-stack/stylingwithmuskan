...
const ActivityPage = () => {
  ...
  const activities = [
    { id: 1, type: "booking", title: "Salon for Women", status: "Completed", date: "Today, 11:30 AM", icon: CheckCircle2, color: "text-emerald-500" },
    { id: 2, type: "wallet", title: "Wallet Recharged", status: "Success", date: "Yesterday", icon: Clock, color: "text-blue-500" },
    { id: 3, type: "booking", title: "Hair Styling", status: "Upcoming", date: "Tomorrow, 2:00 PM", icon: Calendar, color: "text-primary" },
  ];
